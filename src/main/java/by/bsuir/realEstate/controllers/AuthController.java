...
import by.bsuir.realEstate.services.RegistrationService;
import by.bsuir.realEstate.utils.AccountValidator;
...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> update(@PathVariable("id") int id, @RequestHeader("Authorization") String token, @RequestBody @Valid AccountPutDTO accountPutDTO) throws  ObjectIsPresentException, AccessException, ObjectNotFoundException {
